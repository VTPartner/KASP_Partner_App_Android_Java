...
import com.kapstranspvtltd.kaps_partner.goods_driver_activities.documents.main_document_screens.GoodsDriverDocumentVerificationActivity;
...
public class OtpVerificationActivity extends AppCompatActivity {
        ...
        try {
            if (response.has("results") && !response.isNull("results")) {
                ...
                if (result.length() > 0) {
                    ...
                    preferenceManager.saveStringValue("goods_driver_mobile_no", countryCode + mobileNumber);
                    preferenceManager.saveStringValue("goods_driver_id", user.optString("goods_driver_id"));
    ...
    private void saveUserDetails(JSONObject user) {
        preferenceManager.saveStringValue("goods_driver_id", user.optString("goods_driver_id"));
        preferenceManager.saveStringValue("goods_driver_name", user.optString("driver_first_name"));
    ...
    private void navigateToRegistration() {
        Intent intent = new Intent(this, GoodsDriverDocumentVerificationActivity.class);
        startActivity(intent);
        finish();
    }
