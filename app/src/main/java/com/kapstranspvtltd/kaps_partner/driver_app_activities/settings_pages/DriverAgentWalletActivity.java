...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityDriverAgentWalletBinding;
...
public class DriverAgentWalletActivity extends AppCompatActivity implements PaymentResultListener {

    private ActivityDriverAgentWalletBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDriverAgentWalletBinding.inflate(getLayoutInflater());
    ...
    private void fetchWalletDetails() {
        ...
        String url = APIClient.baseUrl + "other_driver_wallet_details";
    ...
    private void initiateWithdrawal(double amount) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST,
                APIClient.baseUrl + "initiate_other_withdrawal",
                params,
                response -> {
                    showLoading(false);
                    try {
