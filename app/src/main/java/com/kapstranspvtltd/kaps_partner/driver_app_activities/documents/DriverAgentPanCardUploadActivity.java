package com.kapstranspvtltd.kaps_partner.driver_app_activities.documents;
...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityCabDriverPanCardUploadBinding;
import com.kapstranspvtltd.kaps_partner.databinding.ActivityDriverAgentPanCardUploadBinding;
...
public class DriverAgentPanCardUploadActivity extends AppCompatActivity {

    private static final String TAG = "DriverAgentPanCardUploadActivity";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityDriverAgentPanCardUploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDriverAgentPanCardUploadBinding.inflate(getLayoutInflater());
    ...
    private void loadSavedData() {
        previousPanFront = preferenceManager.getStringValue("other_driver_pan_front_photo_url");
        previousPanBack = preferenceManager.getStringValue("other_driver_pan_back_photo_url");
        binding.panNumberInput.setText(preferenceManager.getStringValue("other_driver_pan_no"));
    ...
    private void savePanDetails() {
        ...
        preferenceManager.saveStringValue("other_driver_pan_no", panNo);
    ...
    private String createFileName(boolean isFront) {
        ...
        return "other_driver_id_" + driverId + "_" + driverName + "_pan_" +
    ...
    private void updatePreferencesAndUI(String imageUrl, boolean isFront) {
        if (isFront) {
            preferenceManager.saveStringValue("other_driver_pan_front_photo_url", imageUrl);
            previousPanFront = imageUrl;
            loadImage(imageUrl, binding.panFrontImage, binding.panFrontPlaceholder);
        } else {
            preferenceManager.saveStringValue("other_driver_pan_back_photo_url", imageUrl);
    ...
    private boolean isNewEntry() {
        return preferenceManager.getStringValue("other_driver_pan_no").isEmpty() &&
