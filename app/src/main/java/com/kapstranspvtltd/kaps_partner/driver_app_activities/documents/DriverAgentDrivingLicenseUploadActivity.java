...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityCabDriverDrivingLicenseUploadBinding;
...
public class DriverAgentDrivingLicenseUploadActivity extends AppCompatActivity {

    private static final String TAG = "DriverAgentDrivingLicenseUploadActivity";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityDriverAgentDrivingLicenseUploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDriverAgentDrivingLicenseUploadBinding.inflate(getLayoutInflater());
    ...
    private void loadSavedData() {
        previousLicenseFront = preferenceManager.getStringValue("other_driver_license_front_photo_url");
        previousLicenseBack = preferenceManager.getStringValue("other_driver_license_back_photo_url");
        binding.licenseNumberInput.setText(preferenceManager.getStringValue("other_driver_license_no"));
    ...
    private String createFileName(boolean isFront) {
        ...
        return "other_driver_id_" + driverId + "_" + driverName + "_license_" +
    ...
    private void updatePreferencesAndUI(String imageUrl, boolean isFront) {
        if (isFront) {
            preferenceManager.saveStringValue("other_driver_license_front_photo_url", imageUrl);
            previousLicenseFront = imageUrl;
            loadImage(imageUrl, binding.licenseFrontImage, binding.licenseFrontPlaceholder);
        } else {
            preferenceManager.saveStringValue("other_driver_license_back_photo_url", imageUrl);
    ...
    private void saveLicenseDetails() {
        ...
        preferenceManager.saveStringValue("other_driver_license_no", licenseNo);
    ...
    private boolean isNewEntry() {
        return preferenceManager.getStringValue("other_driver_license_no").isEmpty() &&
