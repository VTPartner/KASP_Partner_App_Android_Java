...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityCabDriverAadharCardUploadBinding;
...
public class DriverAgentAadharCardUploadActivity extends AppCompatActivity {

    private static final String TAG = "DriverAgentAadharCardUploadActivity";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityDriverAgentAadharCardUploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDriverAgentAadharCardUploadBinding.inflate(getLayoutInflater());
    ...
    private void loadSavedData() {
        previousAadharFront = preferenceManager.getStringValue("other_driver_aadhar_front_photo_url");
        previousAadharBack = preferenceManager.getStringValue("other_driver_aadhar_back_photo_url");
        binding.aadharNumberInput.setText(preferenceManager.getStringValue("other_driver_aadhar_no"));
    ...
    private String createFileName(boolean isFront) {
        ...
        return "other_driver_id_" + driverId + "_" + driverName + "_aadhar_" +
    ...
    private void updatePreferencesAndUI(String imageUrl, boolean isFront) {
        if (isFront) {
            preferenceManager.saveStringValue("other_driver_aadhar_front_photo_url", imageUrl);
            previousAadharFront = imageUrl;
            loadImage(imageUrl, binding.aadharFrontImage, binding.aadharFrontPlaceholder);
        } else {
            preferenceManager.saveStringValue("other_driver_aadhar_back_photo_url", imageUrl);
    ...
    private void saveAadharDetails() {
        ...
        preferenceManager.saveStringValue("other_driver_aadhar_no", aadharNo);
    ...
    private boolean isNewEntry() {
        return preferenceManager.getStringValue("other_driver_aadhar_no").isEmpty() &&
