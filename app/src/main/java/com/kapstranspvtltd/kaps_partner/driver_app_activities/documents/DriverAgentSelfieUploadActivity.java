...
public class DriverAgentSelfieUploadActivity extends AppCompatActivity {

    private static final String TAG = "DriverAgentSelfieUploadActivity";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityDriverAgentSelfieUploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDriverAgentSelfieUploadBinding.inflate(getLayoutInflater());
    ...
    private void loadSavedData() {
        previousSelfie = preferenceManager.getStringValue("other_driver_selfie_photo_url");
    ...
    private File createImageFile() throws IOException {
        ...
        return File.createTempFile("OTHER_DRIVER_SELFIE_" + timeStamp + "_", ".jpg", storageDir);
    }
            ...
            VolleyFileUploadRequest request = new VolleyFileUploadRequest(
                    ...
                    response -> {
                        try {
                            ...
                            preferenceManager.saveStringValue("other_driver_selfie_photo_url", imageUrl);
