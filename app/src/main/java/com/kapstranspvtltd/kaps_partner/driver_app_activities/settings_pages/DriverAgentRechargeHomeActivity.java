...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityDriverAgentRechargeHomeBinding;
...
public class DriverAgentRechargeHomeActivity extends AppCompatActivity implements PaymentResultListener {
    private ActivityDriverAgentRechargeHomeBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDriverAgentRechargeHomeBinding.inflate(getLayoutInflater());
    ...
    private void fetchRechargePlans() {
        ...
        JSONObject params = new JSONObject();
        try {
            params.put("category_id", 4); // Set your category ID
    ...
    public void onPaymentSuccess(String razorpayPaymentID) {
        try {
            ...
            JsonObjectRequest request = new JsonObjectRequest(
                    Request.Method.POST,
                    APIClient.baseUrl + "other_driver_new_recharge_plan",
                    params,
                    response -> {
                        showLoading(false);
