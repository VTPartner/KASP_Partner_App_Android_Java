...
public class DriverAgentNewBookingAcceptService extends Service {
    private static final String TAG = "DriverAgentFloatingWindow";
    private static final int NOTIFICATION_ID = 54323; // Different from other services
    private static final String CHANNEL_ID = "driver_agent_floating_window_channel";
    ...
    private void createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel serviceChannel = new NotificationChannel(
                    CHANNEL_ID,
                    "Driver Agent Booking Alert Channel",
                    NotificationManager.IMPORTANCE_HIGH
            );

            serviceChannel.setDescription("Shows notifications for new driver agent booking requests");
    ...
    private Notification buildNotification() {
        Intent notificationIntent = new Intent(this, DriverAgentNewLiveRideActivity.class);
        ...
        return new NotificationCompat.Builder(this, CHANNEL_ID)
                .setContentTitle("New Driver Agent Booking Alert")
    ...
    private void fetchBookingDetails(String bookingId) {
        new Thread(() -> {
            try {
                ...
                String url = APIClient.baseUrl + "other_driver_booking_details_for_ride_acceptance";
    ...
    private void initializeFloatingWindow() {
        ...
        floatingView = inflater.inflate(R.layout.driver_agent_booking_accept_layout, null);
    ...
    private void handleAcceptBooking() {
        ...
        executor.execute(() -> {
            try {
                ...
                preferenceManager.saveStringValue("current_other_booking_id_assigned", bookingId);
                ...
                String url = APIClient.baseUrl + "other_driver_booking_accepted";
                ...
                JsonObjectRequest request = new JsonObjectRequest(
                        ...
                        jsonBody,
                        response -> {
                            Intent intent = new Intent(this, DriverAgentNewLiveRideActivity.class);
