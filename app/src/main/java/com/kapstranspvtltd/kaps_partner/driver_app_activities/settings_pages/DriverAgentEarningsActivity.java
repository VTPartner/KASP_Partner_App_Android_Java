...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityDriverAgentEarningsBinding;
...
public class DriverAgentEarningsActivity extends AppCompatActivity {

    private ActivityDriverAgentEarningsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDriverAgentEarningsBinding.inflate(getLayoutInflater());
...
//        binding.toolbar.setNavigationOnClickListener(v -> finish());
    ...
    private void fetchWholeYearsEarnings() {
        ...
        JsonObjectRequest request = new JsonObjectRequest(
                Request.Method.POST,
                APIClient.baseUrl + "other_driver_whole_year_earnings",
                jsonObject,
                response -> {
                    try {
