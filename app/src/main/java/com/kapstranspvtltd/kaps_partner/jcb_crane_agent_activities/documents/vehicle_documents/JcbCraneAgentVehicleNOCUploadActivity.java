...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityJcbCraneAgentVehicleNocuploadBinding;
...
public class JcbCraneAgentVehicleNOCUploadActivity extends AppCompatActivity {

    private static final String TAG = "CabDriverNOCUpload";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityJcbCraneAgentVehicleNocuploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityJcbCraneAgentVehicleNocuploadBinding.inflate(getLayoutInflater());
    ...
    private void loadSavedData() {
        previousNOC = preferenceManager.getStringValue("jcb_crane_agent_noc_photo_url");
        binding.nocNumberInput.setText(preferenceManager.getStringValue("jcb_crane_agent_noc_no"));
    ...
    private void saveNOCDetails() {
        ...
        if (needsImageUpload() && nocImageUri != null) {
            ...
            if (!needsImageUpload() && nocNo.equals(preferenceManager.getStringValue("jcb_crane_agent_noc_no"))) {
                showToast("No changes made");
                return;
            }
            preferenceManager.saveStringValue("jcb_crane_agent_noc_no", nocNo);
    ...
    private void updatePreferencesAndUI(String imageUrl) {
        preferenceManager.saveStringValue("jcb_crane_agent_noc_photo_url", imageUrl);
        previousNOC = imageUrl;
        loadImage(imageUrl, binding.nocImage, binding.nocPlaceholder);
    }

    private boolean isNewEntry() {
        return preferenceManager.getStringValue("jcb_crane_agent_noc_no").isEmpty() &&
