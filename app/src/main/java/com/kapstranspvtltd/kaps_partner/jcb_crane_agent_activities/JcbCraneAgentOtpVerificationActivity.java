...
import com.kapstranspvtltd.kaps_partner.jcb_crane_agent_activities.jcb_crane_main_documents.JcbCraneDocumentVerificationActivity;
...
public class JcbCraneAgentOtpVerificationActivity extends AppCompatActivity {
    ...
    private void verifyOTPAndLogin() {
        showLoading();
        try {
            String url = APIClient.baseUrl + "jcb_crane_driver_login";
    ...
    private void saveUserDetails(JSONObject user) {
        preferenceManager.saveStringValue("jcb_crane_agent_id", user.optString("jcb_crane_driver_id"));
        preferenceManager.saveStringValue("jcb_crane_agent_name", user.optString("driver_first_name"));
    ...
    private void navigateToRegistration() {
        Intent intent = new Intent(this, JcbCraneDocumentVerificationActivity.class);
        startActivity(intent);
        finish();
    }
    ...
    private void checkPermissionsAndProceed() {
        if (areAllPermissionsGranted()) {
            String jcb_craneDriverID = preferenceManager.getStringValue("jcb_crane_agent_id");
            String jcb_craneDriverName = preferenceManager.getStringValue("jcb_crane_agent_name");

            if (jcb_craneDriverID != null && !jcb_craneDriverID.isEmpty() &&
                    jcb_craneDriverName != null && !jcb_craneDriverName.isEmpty() &&
                    !jcb_craneDriverName.equals("NA")) {
                startActivity(new Intent(this, JcbCraneHomeActivity.class));
            } else {
                startActivity(new Intent(this, JcbCraneDocumentVerificationActivity.class));
            }
        } else {
