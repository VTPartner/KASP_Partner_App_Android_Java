...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityDriverAgentSelfieUploadBinding;
import com.kapstranspvtltd.kaps_partner.databinding.ActivityJcbCraneAgentSelfieUploadBinding;
...
public class JcbCraneAgentSelfieUploadActivity extends AppCompatActivity {

    private static final String TAG = "JcbCraneAgentSelfieUploadActivity";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityJcbCraneAgentSelfieUploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityJcbCraneAgentSelfieUploadBinding.inflate(getLayoutInflater());
    ...
    private void loadSavedData() {
        previousSelfie = preferenceManager.getStringValue("jcb_crane_agent_selfie_photo_url");
    ...
    private File createImageFile() throws IOException {
        ...
        return File.createTempFile("jcb_crane_agent_SELFIE_" + timeStamp + "_", ".jpg", storageDir);
    }
            ...
            VolleyFileUploadRequest request = new VolleyFileUploadRequest(
                    ...
                    response -> {
                        try {
                            ...
                            preferenceManager.saveStringValue("jcb_crane_agent_selfie_photo_url", imageUrl);
