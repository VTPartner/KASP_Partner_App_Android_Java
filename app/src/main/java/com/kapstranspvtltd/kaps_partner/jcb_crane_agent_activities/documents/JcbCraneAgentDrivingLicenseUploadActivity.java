...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityJcbCraneAgentDrivingLicenseUploadBinding;
...
public class JcbCraneAgentDrivingLicenseUploadActivity extends AppCompatActivity {

    private static final String TAG = "JcbCraneAgentDrivingLicenseUploadActivity";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityJcbCraneAgentDrivingLicenseUploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityJcbCraneAgentDrivingLicenseUploadBinding.inflate(getLayoutInflater());
    ...
    private void loadSavedData() {
        previousLicenseFront = preferenceManager.getStringValue("jcb_crane_agent_license_front_photo_url");
        previousLicenseBack = preferenceManager.getStringValue("jcb_crane_agent_license_back_photo_url");
        binding.licenseNumberInput.setText(preferenceManager.getStringValue("jcb_crane_agent_license_no"));
    ...
    private String createFileName(boolean isFront) {
        ...
        return "jcb_crane_agent_id_" + driverId + "_" + driverName + "_license_" +
    ...
    private void updatePreferencesAndUI(String imageUrl, boolean isFront) {
        if (isFront) {
            preferenceManager.saveStringValue("jcb_crane_agent_license_front_photo_url", imageUrl);
            previousLicenseFront = imageUrl;
            loadImage(imageUrl, binding.licenseFrontImage, binding.licenseFrontPlaceholder);
        } else {
            preferenceManager.saveStringValue("jcb_crane_agent_license_back_photo_url", imageUrl);
    ...
    private void saveLicenseDetails() {
        ...
        preferenceManager.saveStringValue("jcb_crane_agent_license_no", licenseNo);
    ...
    private boolean isNewEntry() {
        return preferenceManager.getStringValue("jcb_crane_agent_license_no").isEmpty() &&
