package com.kapstranspvtltd.kaps_partner.jcb_crane_agent_activities.documents.owner_documents;
...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityJcbCraneAgentVehicleOwnerSelfieUploadBinding;
...
public class JcbCraneAgentVehicleOwnerSelfieUploadActivity extends AppCompatActivity {

    private static final String TAG = "VehicleOwnerSelfieUploadActivity";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityJcbCraneAgentVehicleOwnerSelfieUploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityJcbCraneAgentVehicleOwnerSelfieUploadBinding.inflate(getLayoutInflater());
    ...
    private void loadSavedData() {
        previousSelfie = preferenceManager.getStringValue("jcb_crane_agent_owner_selfie_photo_url");
    ...
    private File createImageFile() throws IOException {
        ...
        return File.createTempFile("VEHICLE_OWNER_SELFIE_" + timeStamp + "_", ".jpg", storageDir);
    }
    ...
    private void uploadImage(Uri uri) {
        AlertDialog loadingDialog = new MaterialAlertDialogBuilder(this)
                .setTitle("Uploading Vehicle Owner Selfie")
            ...
            VolleyFileUploadRequest request = new VolleyFileUploadRequest(
                    ...
                    response -> {
                        try {
                            ...
                            preferenceManager.saveStringValue("jcb_crane_agent_owner_selfie_photo_url", imageUrl);

                            runOnUiThread(() -> {
                                loadingDialog.dismiss();
                                showToast("Vehicle owner selfie uploaded successfully");
                                finish();
                            });
                        } catch (Exception e) {
                ...
                public Map<String, DataPart> getByteData() throws AuthFailureError {
                    ...
                    try {
                        ...
                        String fileName = "jcb_crane_agent_id_" + driverId + "_" + driverName + "_owner_selfie.jpg";
    ...
    private void handleUploadError(Exception error, Dialog dialog) {
        ...
        runOnUiThread(() -> {
            dialog.dismiss();
            showToast("Failed to upload vehicle owner selfie");
        });
    }
