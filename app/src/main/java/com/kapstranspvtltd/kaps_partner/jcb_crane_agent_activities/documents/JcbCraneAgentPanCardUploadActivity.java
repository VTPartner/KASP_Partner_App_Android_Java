...
public class JcbCraneAgentPanCardUploadActivity extends AppCompatActivity {
    ...
    private void loadSavedData() {
        previousPanFront = preferenceManager.getStringValue("jcb_crane_agent_pan_front_photo_url");
        previousPanBack = preferenceManager.getStringValue("jcb_crane_agent_pan_back_photo_url");
        binding.panNumberInput.setText(preferenceManager.getStringValue("jcb_crane_agent_pan_no"));
    ...
    private void savePanDetails() {
        ...
        preferenceManager.saveStringValue("jcb_crane_agent_pan_no", panNo);
    ...
    private String createFileName(boolean isFront) {
        ...
        return "jcb_crane_agent_id_" + driverId + "_" + driverName + "_pan_" +
    ...
    private void updatePreferencesAndUI(String imageUrl, boolean isFront) {
        if (isFront) {
            preferenceManager.saveStringValue("jcb_crane_agent_pan_front_photo_url", imageUrl);
            previousPanFront = imageUrl;
            loadImage(imageUrl, binding.panFrontImage, binding.panFrontPlaceholder);
        } else {
            preferenceManager.saveStringValue("jcb_crane_agent_pan_back_photo_url", imageUrl);
    ...
    private boolean isNewEntry() {
        return preferenceManager.getStringValue("jcb_crane_agent_pan_no").isEmpty() &&
