...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityJcbCraneAgentVehicleInsuranceUploadBinding;
...
public class JcbCraneAgentVehicleInsuranceUploadActivity extends AppCompatActivity {

    private static final String TAG = "CabDriverInsuranceUpload";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityJcbCraneAgentVehicleInsuranceUploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityJcbCraneAgentVehicleInsuranceUploadBinding.inflate(getLayoutInflater());
    ...
    private void loadSavedData() {
        previousInsurance = preferenceManager.getStringValue("jcb_crane_agent_insurance_photo_url");
        binding.insuranceNumberInput.setText(preferenceManager.getStringValue("jcb_crane_agent_insurance_no"));
    ...
    private void saveInsuranceDetails() {
        ...
        if (needsImageUpload() && insuranceImageUri != null) {
            ...
            if (!needsImageUpload() && insuranceNo.equals(preferenceManager.getStringValue("jcb_crane_agent_insurance_no"))) {
                showToast("No changes made");
                return;
            }
            preferenceManager.saveStringValue("jcb_crane_agent_insurance_no", insuranceNo);
    ...
    private void updatePreferencesAndUI(String imageUrl) {
        preferenceManager.saveStringValue("jcb_crane_agent_insurance_photo_url", imageUrl);
        previousInsurance = imageUrl;
        loadImage(imageUrl, binding.insuranceImage, binding.insurancePlaceholder);
    }

    private boolean isNewEntry() {
        return preferenceManager.getStringValue("jcb_crane_agent_insurance_no").isEmpty() &&
