...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityJcbCraneRechargeHistoryBinding;
import com.kapstranspvtltd.kaps_partner.databinding.ActivityMyRechargeHistoryBinding;
...
public class JcbCraneRechargeHistoryActivity extends AppCompatActivity {
    private ActivityJcbCraneRechargeHistoryBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityJcbCraneRechargeHistoryBinding.inflate(getLayoutInflater());
    ...
    private void fetchRechargeHistory() {
        ...
        try {
            ...
            JsonObjectRequest request = new JsonObjectRequest(
                    Request.Method.POST,
                    APIClient.baseUrl + "get_jcb_crane_driver_new_recharge_plan_history_list",
                    params,
                    response -> {
                        showLoading(false);
