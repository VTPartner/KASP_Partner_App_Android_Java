...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityGoodsDriverVehicleInsuranceUploadBinding;
...
public class GoodsDriverVehicleInsuranceUploadActivity extends AppCompatActivity {
    private static final String TAG = "GoodsDriverInsuranceUpload";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityGoodsDriverVehicleInsuranceUploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityGoodsDriverVehicleInsuranceUploadBinding.inflate(getLayoutInflater());
    ...
    private void loadSavedData() {
        previousInsurance = preferenceManager.getStringValue("insurance_photo_url");
        binding.insuranceNumberInput.setText(preferenceManager.getStringValue("insurance_no"));
    ...
    private void saveInsuranceDetails() {
        ...
        if (needsImageUpload() && insuranceImageUri != null) {
            ...
            if (!needsImageUpload() && insuranceNo.equals(preferenceManager.getStringValue("insurance_no"))) {
    ...
    private boolean isNewEntry() {
        return preferenceManager.getStringValue("insurance_no").isEmpty() &&
