...
public class MyRechargeHistoryActivity extends AppCompatActivity {
    private ActivityMyRechargeHistoryBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityMyRechargeHistoryBinding.inflate(getLayoutInflater());
    ...
    private void fetchRechargeHistory() {
        ...
        try {
            ...
            JsonObjectRequest request = new JsonObjectRequest(
                    Request.Method.POST,
                    APIClient.baseUrl + "get_goods_driver_new_recharge_plan_history_list",
                    params,
                    response -> {
                        showLoading(false);
