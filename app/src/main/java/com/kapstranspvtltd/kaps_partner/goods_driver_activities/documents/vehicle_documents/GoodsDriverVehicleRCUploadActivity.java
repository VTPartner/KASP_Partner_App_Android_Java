...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityGoodsDriverVehicleRcuploadBinding;
...
public class GoodsDriverVehicleRCUploadActivity extends AppCompatActivity {
    private static final String TAG = "GoodsDriverRCUpload";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityGoodsDriverVehicleRcuploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityGoodsDriverVehicleRcuploadBinding.inflate(getLayoutInflater());
    ...
    private void loadSavedData() {
        previousRC = preferenceManager.getStringValue("rc_photo_url");
        binding.rcNumberInput.setText(preferenceManager.getStringValue("rc_no"));
    ...
    private void saveRCDetails() {
        ...
        if (needsImageUpload() && rcImageUri != null) {
            ...
            if (!needsImageUpload() && rcNo.equals(preferenceManager.getStringValue("rc_no"))) {
    ...
    private boolean isNewEntry() {
        return preferenceManager.getStringValue("rc_no").isEmpty() &&
