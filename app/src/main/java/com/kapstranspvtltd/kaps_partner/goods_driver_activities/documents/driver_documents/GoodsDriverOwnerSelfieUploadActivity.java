...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityGoodsDriverOwnerSelfieUploadBinding;
...
public class GoodsDriverOwnerSelfieUploadActivity extends AppCompatActivity {
    private static final String TAG = "OwnerSelfieUploadActivity";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityGoodsDriverOwnerSelfieUploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityGoodsDriverOwnerSelfieUploadBinding.inflate(getLayoutInflater());
