...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityGoodsDriverVehicleImageUploadBinding;
...
public class GoodsDriverVehicleImageUploadActivity extends AppCompatActivity {
    private static final String TAG = "GoodsDriverVehicleImageUploadActivity";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityGoodsDriverVehicleImageUploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityGoodsDriverVehicleImageUploadBinding.inflate(getLayoutInflater());
    ...
    private void loadSavedData() {
        previousVehicleFront = preferenceManager.getStringValue("vehicle_front_photo_url");
        previousVehicleBack = preferenceManager.getStringValue("vehicle_back_photo_url");
