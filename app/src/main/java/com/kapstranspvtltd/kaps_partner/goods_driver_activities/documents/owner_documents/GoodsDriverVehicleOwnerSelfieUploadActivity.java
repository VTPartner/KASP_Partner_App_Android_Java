package com.kapstranspvtltd.kaps_partner.goods_driver_activities.documents.owner_documents;
...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityGoodsDriverVehicleOwnerSelfieUploadBinding;
...
public class GoodsDriverVehicleOwnerSelfieUploadActivity extends AppCompatActivity {
    private static final String TAG = "VehicleOwnerSelfieUploadActivity";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityGoodsDriverVehicleOwnerSelfieUploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityGoodsDriverVehicleOwnerSelfieUploadBinding.inflate(getLayoutInflater());
