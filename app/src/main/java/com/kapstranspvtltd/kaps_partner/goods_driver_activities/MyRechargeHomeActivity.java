...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityMyRechargeHomeBinding;
...
public class MyRechargeHomeActivity extends AppCompatActivity implements PaymentResultListener {
    private ActivityMyRechargeHomeBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityMyRechargeHomeBinding.inflate(getLayoutInflater());
...
//        }
    ...
    public void onPaymentSuccess(String razorpayPaymentID) {
        try {
            ...
            JsonObjectRequest request = new JsonObjectRequest(
                    Request.Method.POST,
                    APIClient.baseUrl + "new_goods_driver_new_recharge_plan",
                    params,
                    response -> {
                        showLoading(false);
