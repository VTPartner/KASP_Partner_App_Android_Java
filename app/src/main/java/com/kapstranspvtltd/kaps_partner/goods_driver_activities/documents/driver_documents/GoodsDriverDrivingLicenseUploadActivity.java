...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityGoodsDriverDrivingLicenseUploadBinding;
...
public class GoodsDriverDrivingLicenseUploadActivity extends AppCompatActivity {
    private static final String TAG = "GoodsDriverLicenseUploadActivity";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityGoodsDriverDrivingLicenseUploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityGoodsDriverDrivingLicenseUploadBinding.inflate(getLayoutInflater());
    ...
    private void loadSavedData() {
        previousLicenseFront = preferenceManager.getStringValue("license_front_photo_url");
        previousLicenseBack = preferenceManager.getStringValue("license_back_photo_url");
        binding.licenseNumberInput.setText(preferenceManager.getStringValue("license_no"));
    ...
    private boolean isNewEntry() {
        return preferenceManager.getStringValue("license_no").isEmpty() &&
