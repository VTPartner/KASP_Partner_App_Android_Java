...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityGoodsDriverAadharCardUploadBinding;
...
public class GoodsDriverAadharCardUploadActivity extends AppCompatActivity {
    private static final String TAG = "GoodsDriverAadharUploadActivity";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityGoodsDriverAadharCardUploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityGoodsDriverAadharCardUploadBinding.inflate(getLayoutInflater());
    ...
    private void loadSavedData() {
        previousAadharFront = preferenceManager.getStringValue("aadhar_front_photo_url");
        previousAadharBack = preferenceManager.getStringValue("aadhar_back_photo_url");
        binding.aadharNumberInput.setText(preferenceManager.getStringValue("aadhar_no"));
    ...
    private boolean isNewEntry() {
        return preferenceManager.getStringValue("aadhar_no").isEmpty() &&
