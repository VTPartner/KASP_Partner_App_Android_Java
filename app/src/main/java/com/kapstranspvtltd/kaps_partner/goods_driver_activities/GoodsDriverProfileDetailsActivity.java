...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityGoodsDriverProfileDetailsBinding;
...
public class GoodsDriverProfileDetailsActivity extends AppCompatActivity {
    private ActivityGoodsDriverProfileDetailsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityGoodsDriverProfileDetailsBinding.inflate(getLayoutInflater());
...
//        }
        ...
        driverId = preferenceManager.getStringValue("goods_driver_id");
    ...
    private void loadDriverDetails() {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST,
                APIClient.baseUrl + "get_goods_driver_details",
                jsonBody,
                response -> {
...
//        }
    ...
    private void updateProfile() {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST,
                APIClient.baseUrl + "update_goods_driver_details",
                jsonBody,
                response -> {
                    progressDialog.dismiss();
