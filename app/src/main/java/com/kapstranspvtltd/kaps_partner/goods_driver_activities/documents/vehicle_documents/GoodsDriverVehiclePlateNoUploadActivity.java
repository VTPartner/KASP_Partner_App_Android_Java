...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityGoodsDriverVehiclePlateNoUploadBinding;
...
public class GoodsDriverVehiclePlateNoUploadActivity extends AppCompatActivity {
    private static final String TAG = "GoodsDriverPlateNoUploadActivity";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityGoodsDriverVehiclePlateNoUploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityGoodsDriverVehiclePlateNoUploadBinding.inflate(getLayoutInflater());
    ...
    private void loadSavedData() {
        previousPlateFront = preferenceManager.getStringValue("vehicle_plate_front_photo_url");
        previousPlateBack = preferenceManager.getStringValue("vehicle_plate_back_photo_url");
