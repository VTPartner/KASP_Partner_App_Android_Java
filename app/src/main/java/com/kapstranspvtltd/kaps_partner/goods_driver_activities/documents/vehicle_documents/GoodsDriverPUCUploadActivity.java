...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityGoodsDriverPucuploadBinding;
...
public class GoodsDriverPUCUploadActivity extends AppCompatActivity {
    private static final String TAG = "GoodsDriverPUCUploadActivity";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityGoodsDriverPucuploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityGoodsDriverPucuploadBinding.inflate(getLayoutInflater());
    ...
    private void loadSavedData() {
        previousPUC = preferenceManager.getStringValue("puc_photo_url");
        binding.pucNumberInput.setText(preferenceManager.getStringValue("puc_no"));
    ...
    private void savePUCDetails() {
        ...
        if (needsImageUpload() && pucImageUri != null) {
            ...
            if (!needsImageUpload() && pucNo.equals(preferenceManager.getStringValue("puc_no"))) {
    ...
    private boolean isNewEntry() {
        return preferenceManager.getStringValue("puc_no").isEmpty() &&
