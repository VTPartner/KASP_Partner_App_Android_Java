...
public class HandyManFAQSActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_handy_man_faqsactivity);
        // Setup toolbar
...
//        }
        ...
        categoryId = getIntent().getLongExtra("category_id", 5);
...
//                    Toast.makeText(this, "No FAQS", Toast.LENGTH_SHORT).show();
                    handleError(error);
                }) {
            @Override
