...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityHandyManRechargeHomeBinding;
...
public class HandyManRechargeHomeActivity extends AppCompatActivity implements PaymentResultListener {
    private ActivityHandyManRechargeHomeBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityHandyManRechargeHomeBinding.inflate(getLayoutInflater());
...
//        }
    ...
    private void fetchRechargePlans() {
        ...
        JSONObject params = new JSONObject();
        try {
            params.put("category_id", 5); // Set your category ID
    ...
    public void onPaymentSuccess(String razorpayPaymentID) {
        try {
            ...
            JsonObjectRequest request = new JsonObjectRequest(
                    Request.Method.POST,
                    APIClient.baseUrl + "handyman_new_recharge_plan",
                    params,
                    response -> {
                        showLoading(false);
