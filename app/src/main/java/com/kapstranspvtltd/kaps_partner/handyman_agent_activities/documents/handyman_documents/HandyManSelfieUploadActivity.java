...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityHandyManSelfieBinding;
...
public class HandyManSelfieUploadActivity extends AppCompatActivity {

    private static final String TAG = "HandyManSelfieUploadActivity";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityHandyManSelfieBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityHandyManSelfieBinding.inflate(getLayoutInflater());
    ...
    private void loadSavedData() {
        previousSelfie = preferenceManager.getStringValue("handyman_agent_selfie_photo_url");
    ...
    private File createImageFile() throws IOException {
        ...
        return File.createTempFile("handyman_agent_SELFIE_" + timeStamp + "_", ".jpg", storageDir);
    }
            ...
            VolleyFileUploadRequest request = new VolleyFileUploadRequest(
                    ...
                    response -> {
                        try {
                            ...
                            preferenceManager.saveStringValue("handyman_agent_selfie_photo_url", imageUrl);
