...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityHandyManAadharCardUploadBinding;
...
public class HandyManAadharCardUploadActivity extends AppCompatActivity {

    private static final String TAG = "HandyManAadharCardUploadActivity";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityHandyManAadharCardUploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityHandyManAadharCardUploadBinding.inflate(getLayoutInflater());
    ...
    private void loadSavedData() {
        previousAadharFront = preferenceManager.getStringValue("handyman_agent_aadhar_front_photo_url");
        previousAadharBack = preferenceManager.getStringValue("handyman_agent_aadhar_back_photo_url");
        binding.aadharNumberInput.setText(preferenceManager.getStringValue("handyman_agent_aadhar_no"));
    ...
    private String createFileName(boolean isFront) {
        ...
        return "handyman_id_" + driverId + "_" + driverName + "_aadhar_" +
    ...
    private void updatePreferencesAndUI(String imageUrl, boolean isFront) {
        if (isFront) {
            preferenceManager.saveStringValue("handyman_agent_aadhar_front_photo_url", imageUrl);
            previousAadharFront = imageUrl;
            loadImage(imageUrl, binding.aadharFrontImage, binding.aadharFrontPlaceholder);
        } else {
            preferenceManager.saveStringValue("handyman_agent_aadhar_back_photo_url", imageUrl);
    ...
    private void saveAadharDetails() {
        ...
        preferenceManager.saveStringValue("handyman_agent_aadhar_no", aadharNo);
    ...
    private boolean isNewEntry() {
        return preferenceManager.getStringValue("handyman_agent_aadhar_no").isEmpty() &&
