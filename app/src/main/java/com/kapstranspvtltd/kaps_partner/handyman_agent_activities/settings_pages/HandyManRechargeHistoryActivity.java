...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityHandyManRechargeHistoryBinding;
...
public class HandyManRechargeHistoryActivity extends AppCompatActivity {

    private ActivityHandyManRechargeHistoryBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityHandyManRechargeHistoryBinding.inflate(getLayoutInflater());
    ...
    private void fetchRechargeHistory() {
        ...
        try {
            ...
            JsonObjectRequest request = new JsonObjectRequest(
                    Request.Method.POST,
                    APIClient.baseUrl + "get_handyman_new_recharge_plan_history_list",
                    params,
                    response -> {
                        showLoading(false);
