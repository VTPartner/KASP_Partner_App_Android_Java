...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityHandyManEarningsBinding;
...
public class HandyManEarningsActivity extends AppCompatActivity {

    private ActivityHandyManEarningsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityHandyManEarningsBinding.inflate(getLayoutInflater());
...
//        binding.toolbar.setNavigationOnClickListener(v -> finish());
    ...
    private void fetchWholeYearsEarnings() {
        ...
        JsonObjectRequest request = new JsonObjectRequest(
                Request.Method.POST,
                APIClient.baseUrl + "handyman_whole_year_earnings",
                jsonObject,
                response -> {
                    try {
    ...
    private void fetchAllOrders() {
        ...
        JsonObjectRequest request = new JsonObjectRequest(
                Request.Method.POST,
                APIClient.baseUrl + "handyman_all_orders",
                jsonObject,
                response -> {
                    try {
                        JSONArray results = response.getJSONArray("results");
    ...
    private String getDriverId() {
        return preferenceManager.getStringValue("handyman_agent_id");
    }
    ...
    private void handleError(VolleyError error) {
        ...
        if (error.networkResponse != null) {
            ...
            switch (statusCode) {
                ...
                case 404:
                    message = "You have not yet completed any service requests";
                    break;
                case 400:
                    message = "Bad request";
                    break;
