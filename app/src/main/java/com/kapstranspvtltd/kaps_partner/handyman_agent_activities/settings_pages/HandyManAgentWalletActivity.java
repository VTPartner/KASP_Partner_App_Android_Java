...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityHandyManAgentWalletBinding;
...
public class HandyManAgentWalletActivity extends AppCompatActivity implements PaymentResultListener {

    private ActivityHandyManAgentWalletBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityHandyManAgentWalletBinding.inflate(getLayoutInflater());
    ...
    private void fetchWalletDetails() {
        showLoading(true);
        String token = preferenceManager.getStringValue("handyman_token");
        String handymanId = preferenceManager.getStringValue("handyman_agent_id");

        JSONObject params = new JSONObject();
        try {
            params.put("handyman_id", handymanId);
            params.put("handyman_unique_id", handymanId);
            params.put("auth", token);
        } catch (JSONException e) {
            e.printStackTrace();
        }

        String url = APIClient.baseUrl + "handyman_wallet_details";
    ...
    private void initiateWithdrawal(double amount) {
        showLoading(true);
        String handymanId = preferenceManager.getStringValue("handyman_id");
        String token = preferenceManager.getStringValue("handyman_token");
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST,
                APIClient.baseUrl + "initiate_handyman_withdrawal",
                params,
                response -> {
                    showLoading(false);
                    try {
