...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityHandyManPanCardUploadBinding;
...
public class HandyManPanCardUploadActivity extends AppCompatActivity {

    private static final String TAG = "HandyManPanCardUploadActivity";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityHandyManPanCardUploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityHandyManPanCardUploadBinding.inflate(getLayoutInflater());
    ...
    private void loadSavedData() {
        previousPanFront = preferenceManager.getStringValue("handyman_agent_pan_front_photo_url");
        previousPanBack = preferenceManager.getStringValue("handyman_agent_pan_back_photo_url");
        binding.panNumberInput.setText(preferenceManager.getStringValue("handyman_agent_pan_no"));
    ...
    private void savePanDetails() {
        ...
        preferenceManager.saveStringValue("handyman_agent_pan_no", panNo);
    ...
    private String createFileName(boolean isFront) {
        ...
        return "handyman_agent_id_" + driverId + "_" + driverName + "_pan_" +
    ...
    private void updatePreferencesAndUI(String imageUrl, boolean isFront) {
        if (isFront) {
            preferenceManager.saveStringValue("handyman_agent_pan_front_photo_url", imageUrl);
            previousPanFront = imageUrl;
            loadImage(imageUrl, binding.panFrontImage, binding.panFrontPlaceholder);
        } else {
            preferenceManager.saveStringValue("handyman_agent_pan_back_photo_url", imageUrl);
    ...
    private boolean isNewEntry() {
        return preferenceManager.getStringValue("handyman_agent_pan_no").isEmpty() &&
