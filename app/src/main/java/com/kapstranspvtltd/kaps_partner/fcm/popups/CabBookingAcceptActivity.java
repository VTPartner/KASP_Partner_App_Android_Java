...
public class CabBookingAcceptActivity extends AppCompatActivity {

    private static final String TAG = "CabBookingAccept";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cab_booking_accept2);
        turnScreenOn();
        ...
        executor.execute(() -> {
            try {
                ...
                if (accessToken == null || accessToken.isEmpty()) {
                    handler.post(() -> {
                        progressDialog.dismiss();
                        Toast.makeText(CabBookingAcceptActivity.this,
                ...
                preferenceManager.saveStringValue("cab_current_booking_id_assigned", bookingId);
                ...
                JsonObjectRequest request = new JsonObjectRequest(
                        ...
                        response -> {
                            ...
                            Intent intent = new Intent(CabBookingAcceptActivity.this,
                                    CabDriverNewLiveRideActivity.class);
                ...
                handler.post(() -> {
                    VolleySingleton.getInstance(CabBookingAcceptActivity.this)
    ...
    private void handleNoDataFound() {
        ...
        getSharedPreferences("MyPrefs", MODE_PRIVATE)
                .edit()
                .putString("cab_current_booking_id_assigned", "")
                .apply();

        Toast.makeText(
                this,
                "Already Assigned to Another Driver.\nPlease be quick at receiving cab ride requests to earn more.",
                Toast.LENGTH_LONG
        ).show();
        finish();
    }
