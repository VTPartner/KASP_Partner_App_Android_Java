...
public class CabDriverPanCardUploadActivity extends AppCompatActivity {

    private static final String TAG = "CabDriverPanCardUploadActivity";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityCabDriverPanCardUploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCabDriverPanCardUploadBinding.inflate(getLayoutInflater());
    ...
    private void loadSavedData() {
        previousPanFront = preferenceManager.getStringValue("cab_driver_pan_front_photo_url");
        previousPanBack = preferenceManager.getStringValue("cab_driver_pan_back_photo_url");
        binding.panNumberInput.setText(preferenceManager.getStringValue("cab_driver_pan_no"));
    ...
    private void savePanDetails() {
        ...
        preferenceManager.saveStringValue("cab_driver_pan_no", panNo);
    ...
    private void updatePreferencesAndUI(String imageUrl, boolean isFront) {
        if (isFront) {
            preferenceManager.saveStringValue("cab_driver_pan_front_photo_url", imageUrl);
            previousPanFront = imageUrl;
            loadImage(imageUrl, binding.panFrontImage, binding.panFrontPlaceholder);
        } else {
            preferenceManager.saveStringValue("cab_driver_pan_back_photo_url", imageUrl);
    ...
    private boolean isNewEntry() {
        return preferenceManager.getStringValue("cab_driver_pan_no").isEmpty() &&
