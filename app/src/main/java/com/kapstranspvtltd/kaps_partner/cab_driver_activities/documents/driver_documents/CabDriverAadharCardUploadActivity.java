...
public class CabDriverAadharCardUploadActivity extends AppCompatActivity {

    private static final String TAG = "CabDriverAadharUploadActivity";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityCabDriverAadharCardUploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCabDriverAadharCardUploadBinding.inflate(getLayoutInflater());
    ...
    private void loadSavedData() {
        previousAadharFront = preferenceManager.getStringValue("cab_driver_aadhar_front_photo_url");
        previousAadharBack = preferenceManager.getStringValue("cab_driver_aadhar_back_photo_url");
        binding.aadharNumberInput.setText(preferenceManager.getStringValue("cab_driver_aadhar_no"));
    ...
    private String createFileName(boolean isFront) {
        ...
        return "goods_driver_id_" + driverId + "_" + driverName + "_aadhar_" +
    ...
    private void updatePreferencesAndUI(String imageUrl, boolean isFront) {
        if (isFront) {
            preferenceManager.saveStringValue("cab_driver_aadhar_front_photo_url", imageUrl);
            previousAadharFront = imageUrl;
            loadImage(imageUrl, binding.aadharFrontImage, binding.aadharFrontPlaceholder);
        } else {
            preferenceManager.saveStringValue("cab_driver_aadhar_back_photo_url", imageUrl);
    ...
    private void saveAadharDetails() {
        ...
        preferenceManager.saveStringValue("cab_driver_aadhar_no", aadharNo);
    ...
    private boolean isNewEntry() {
        return preferenceManager.getStringValue("cab_driver_aadhar_no").isEmpty() &&
