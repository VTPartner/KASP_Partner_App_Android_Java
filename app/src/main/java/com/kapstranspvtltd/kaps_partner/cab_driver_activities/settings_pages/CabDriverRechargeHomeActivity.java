...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityCabDriverRechargeHomeBinding;
...
public class CabDriverRechargeHomeActivity extends AppCompatActivity implements PaymentResultListener {
    private ActivityCabDriverRechargeHomeBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCabDriverRechargeHomeBinding.inflate(getLayoutInflater());
    ...
    public void onPaymentSuccess(String razorpayPaymentID) {
        try {
            ...
            JsonObjectRequest request = new JsonObjectRequest(
                    Request.Method.POST,
                    APIClient.baseUrl + "new_cab_driver_new_recharge_plan",
                    params,
                    response -> {
                        showLoading(false);
