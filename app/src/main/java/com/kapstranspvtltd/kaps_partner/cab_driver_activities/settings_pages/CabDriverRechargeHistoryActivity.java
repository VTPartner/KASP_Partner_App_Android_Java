...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityCabDriverRechargeHistoryBinding;
...
public class CabDriverRechargeHistoryActivity extends AppCompatActivity {

    private ActivityCabDriverRechargeHistoryBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCabDriverRechargeHistoryBinding.inflate(getLayoutInflater());
    ...
    private void fetchRechargeHistory() {
        ...
        try {
            ...
            JsonObjectRequest request = new JsonObjectRequest(
                    Request.Method.POST,
                    APIClient.baseUrl + "get_cab_driver_new_recharge_plan_history_list",
                    params,
                    response -> {
                        showLoading(false);
