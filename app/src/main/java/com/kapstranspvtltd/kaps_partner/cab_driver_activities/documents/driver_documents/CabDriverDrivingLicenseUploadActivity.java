...
public class CabDriverDrivingLicenseUploadActivity extends AppCompatActivity {

    private static final String TAG = "CabDriverLicenseUploadActivity";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityCabDriverDrivingLicenseUploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCabDriverDrivingLicenseUploadBinding.inflate(getLayoutInflater());
    ...
    private void loadSavedData() {
        previousLicenseFront = preferenceManager.getStringValue("cab_driver_license_front_photo_url");
        previousLicenseBack = preferenceManager.getStringValue("cab_driver_license_back_photo_url");
        binding.licenseNumberInput.setText(preferenceManager.getStringValue("cab_driver_license_no"));
    ...
    private String createFileName(boolean isFront) {
        ...
        return "goods_driver_id_" + driverId + "_" + driverName + "_license_" +
    ...
    private void updatePreferencesAndUI(String imageUrl, boolean isFront) {
        if (isFront) {
            preferenceManager.saveStringValue("cab_driver_license_front_photo_url", imageUrl);
            previousLicenseFront = imageUrl;
            loadImage(imageUrl, binding.licenseFrontImage, binding.licenseFrontPlaceholder);
        } else {
            preferenceManager.saveStringValue("cab_driver_license_back_photo_url", imageUrl);
    ...
    private void saveLicenseDetails() {
        ...
        preferenceManager.saveStringValue("cab_driver_license_no", licenseNo);
    ...
    private boolean isNewEntry() {
        return preferenceManager.getStringValue("cab_driver_license_no").isEmpty() &&
