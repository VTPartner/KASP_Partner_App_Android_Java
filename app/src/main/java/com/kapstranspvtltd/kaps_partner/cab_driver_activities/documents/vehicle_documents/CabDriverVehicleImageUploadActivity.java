...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityCabDriverVehicleImageUploadBinding;
...
public class CabDriverVehicleImageUploadActivity extends AppCompatActivity {

    private static final String TAG = "CabDriverVehicleImageUploadActivity";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityCabDriverVehicleImageUploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCabDriverVehicleImageUploadBinding.inflate(getLayoutInflater());
    ...
    private void loadSavedData() {
        previousVehicleFront = preferenceManager.getStringValue("cab_driver_vehicle_front_photo_url");
        previousVehicleBack = preferenceManager.getStringValue("cab_driver_vehicle_back_photo_url");
    ...
    private void updatePreferencesAndUI(String imageUrl, boolean isFront) {
        if (isFront) {
            preferenceManager.saveStringValue("cab_driver_vehicle_front_photo_url", imageUrl);
            previousVehicleFront = imageUrl;
            loadImage(imageUrl, binding.vehicleFrontImage, binding.vehicleFrontPlaceholder);
        } else {
            preferenceManager.saveStringValue("cab_driver_vehicle_back_photo_url", imageUrl);
