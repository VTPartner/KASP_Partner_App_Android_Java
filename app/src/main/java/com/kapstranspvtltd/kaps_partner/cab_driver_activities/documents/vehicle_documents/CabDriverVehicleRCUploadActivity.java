...
public class CabDriverVehicleRCUploadActivity extends AppCompatActivity {
    ...
    private void loadSavedData() {
        previousRC = preferenceManager.getStringValue("cab_driver_rc_photo_url");
        binding.rcNumberInput.setText(preferenceManager.getStringValue("cab_driver_rc_no"));
    ...
    private void saveRCDetails() {
        ...
        if (needsImageUpload() && rcImageUri != null) {
            ...
            if (!needsImageUpload() && rcNo.equals(preferenceManager.getStringValue("cab_driver_rc_no"))) {
                showToast("No changes made");
                return;
            }
            preferenceManager.saveStringValue("cab_driver_rc_no", rcNo);
    ...
    private void updatePreferencesAndUI(String imageUrl) {
        preferenceManager.saveStringValue("cab_driver_rc_photo_url", imageUrl);
        previousRC = imageUrl;
        loadImage(imageUrl, binding.rcImage, binding.rcPlaceholder);
    }

    private boolean isNewEntry() {
        return preferenceManager.getStringValue("cab_driver_rc_no").isEmpty() &&
