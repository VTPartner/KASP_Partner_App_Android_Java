package com.kapstranspvtltd.kaps_partner.cab_driver_activities.documents.owner_documents;
...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityCabDriverVehicleOwnerSelfieUploadBinding;
...
public class CabDriverVehicleOwnerSelfieUploadActivity extends AppCompatActivity {

    private static final String TAG = "VehicleOwnerSelfieUploadActivity";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityCabDriverVehicleOwnerSelfieUploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCabDriverVehicleOwnerSelfieUploadBinding.inflate(getLayoutInflater());
    ...
    private void loadSavedData() {
        previousSelfie = preferenceManager.getStringValue("cab_driver_owner_selfie_photo_url");
            ...
            VolleyFileUploadRequest request = new VolleyFileUploadRequest(
                    ...
                    response -> {
                        try {
                            ...
                            preferenceManager.saveStringValue("cab_driver_owner_selfie_photo_url", imageUrl);
                ...
                public Map<String, DataPart> getByteData() throws AuthFailureError {
                    ...
                    try {
                        ...
                        String fileName = "goods_driver_id_" + driverId + "_" + driverName + "_owner_selfie.jpg";
