...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityCabDriverPucuploadBinding;
...
public class CabDriverPUCUploadActivity extends AppCompatActivity {

    private static final String TAG = "CabDriverPUCUploadActivity";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityCabDriverPucuploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCabDriverPucuploadBinding.inflate(getLayoutInflater());
    ...
    private void loadSavedData() {
        previousPUC = preferenceManager.getStringValue("cab_driver_puc_photo_url");
        binding.pucNumberInput.setText(preferenceManager.getStringValue("cab_driver_puc_no"));
    ...
    private void savePUCDetails() {
        ...
        if (needsImageUpload() && pucImageUri != null) {
            ...
            if (!needsImageUpload() && pucNo.equals(preferenceManager.getStringValue("cab_driver_puc_no"))) {
                showToast("No changes made");
                return;
            }
            preferenceManager.saveStringValue("cab_driver_puc_no", pucNo);
    ...
    private void updatePreferencesAndUI(String imageUrl) {
        preferenceManager.saveStringValue("cab_driver_puc_photo_url", imageUrl);
        previousPUC = imageUrl;
        loadImage(imageUrl, binding.pucImage, binding.pucPlaceholder);
    }

    private boolean isNewEntry() {
        return preferenceManager.getStringValue("cab_driver_puc_no").isEmpty() &&
