...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityCabDriverVehiclePlateNoUploadBinding;
...
public class CabDriverVehiclePlateNoUploadActivity extends AppCompatActivity {

    private static final String TAG = "CabDriverPlateNoUploadActivity";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityCabDriverVehiclePlateNoUploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCabDriverVehiclePlateNoUploadBinding.inflate(getLayoutInflater());
    ...
    private void loadSavedData() {
        previousPlateFront = preferenceManager.getStringValue("cab_driver_vehicle_plate_front_photo_url");
        previousPlateBack = preferenceManager.getStringValue("cab_driver_vehicle_plate_back_photo_url");
    ...
    private void updatePreferencesAndUI(String imageUrl, boolean isFront) {
        if (isFront) {
            preferenceManager.saveStringValue("cab_driver_vehicle_plate_front_photo_url", imageUrl);
            previousPlateFront = imageUrl;
            loadImage(imageUrl, binding.plateFrontImage, binding.plateFrontPlaceholder);
        } else {
            preferenceManager.saveStringValue("cab_driver_vehicle_plate_back_photo_url", imageUrl);
