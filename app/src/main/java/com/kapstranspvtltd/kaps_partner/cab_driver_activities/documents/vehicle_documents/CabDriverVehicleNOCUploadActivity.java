...
import com.kapstranspvtltd.kaps_partner.databinding.ActivityCabDriverVehicleNocuploadBinding;
...
public class CabDriverVehicleNOCUploadActivity extends AppCompatActivity {

    private static final String TAG = "CabDriverNOCUpload";
    private static final int CAMERA_PERMISSION_REQUEST = 100;

    private ActivityCabDriverVehicleNocuploadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCabDriverVehicleNocuploadBinding.inflate(getLayoutInflater());
    ...
    private void loadSavedData() {
        previousNOC = preferenceManager.getStringValue("cab_driver_noc_photo_url");
        binding.nocNumberInput.setText(preferenceManager.getStringValue("cab_driver_noc_no"));
    ...
    private void saveNOCDetails() {
        ...
        if (needsImageUpload() && nocImageUri != null) {
            ...
            if (!needsImageUpload() && nocNo.equals(preferenceManager.getStringValue("cab_driver_noc_no"))) {
                showToast("No changes made");
                return;
            }
            preferenceManager.saveStringValue("cab_driver_noc_no", nocNo);
    ...
    private void updatePreferencesAndUI(String imageUrl) {
        preferenceManager.saveStringValue("cab_driver_noc_photo_url", imageUrl);
        previousNOC = imageUrl;
        loadImage(imageUrl, binding.nocImage, binding.nocPlaceholder);
    }

    private boolean isNewEntry() {
        return preferenceManager.getStringValue("cab_driver_noc_no").isEmpty() &&
